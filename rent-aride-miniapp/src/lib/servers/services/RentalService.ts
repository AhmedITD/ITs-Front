...
import type { InvoiceResponse, RentalHistoryItemDto } from '../../types/rental.js'
...
export class RentalService {
  ...
  async createInvoice(data: {
    ...
    return httpClient.post<InvoiceResponse>(`${this.base}/invoice`, data)
  }
  ...
  async getMyHistory(params: {
    ...
    return httpClient.get<PaginatedList<RentalHistoryItemDto>>(`${this.base}/my-history`, {
      params: cleaned,
    })
  }
}
