...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/rentals/new',
    name: 'rental-new',
    component: () => import('@/pages/Rents/CreateRentalPage.vue'),
  ...
  },
  {
    path: '/rentals',
    name: 'rentals',
    component: () => import('@/pages/Rents/Index.vue'),
  ...
  },
  {
    ...
    component: () => import('@/pages/admin/Vehicles/VehicleTypesPage.vue'),
  ...
  },
  {
    path: '/admin/vehicles',
    name: 'admin-vehicles',
    component: () => import('@/pages/admin/Vehicles/VehiclesPage.vue'),
